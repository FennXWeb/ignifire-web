const SHELL_CACHE='ignifire-web-shell-v2';
const SHELL_FILES=[
  './',
  './index.html',
  './styles.css',
...
self.addEventListener('fetch',event=>{
  ...
  // Account responses and audio streams are private, time-sensitive, and must
  // never be stored in the offline application-shell cache.
